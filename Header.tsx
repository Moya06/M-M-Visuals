    ...
    >
      <div className="max-w-[1300px] mx-auto px-6">
        <nav className="flex justify-between items-center py-2.5">
          ...
          <a href="#inicio" className="flex items-center gap-4 no-underline group py-1">
            ...
            <ul className="flex list-none gap-7 items-center m-0 p-0">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className={`text-xs font-semibold tracking-[1.5px] uppercase no-underline transition-colors duration-300 relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-[1.5px] after:bg-[var(--accent)] after:transition-all after:duration-300 hover:after:w-full ${active === link.href.slice(1)
