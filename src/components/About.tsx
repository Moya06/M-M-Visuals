...
export function About() {
  ...
  return (
    <section className="py-16 sm:py-24 md:py-[120px] bg-[var(--bg-secondary)] border-t border-[var(--border-color)] scroll-mt-20" id="sobre-mi">
      <div className="max-w-[1300px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-20 items-center">
          ...
          <div ref={rightRef} className={`transition-all duration-700 ease-out ${rightVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-[var(--text-muted)] mb-4 sm:mb-5 text-sm sm:text-[15px] leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-4 sm:mt-5">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full border border-[var(--accent)]/50 text-[var(--accent)] text-[11px] sm:text-xs tracking-[1px] uppercase font-semibold">
