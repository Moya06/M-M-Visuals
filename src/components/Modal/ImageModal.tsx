  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="flex flex-col min-w-0">
            <div className="flex items-center gap-2">
              <h3 className={`font-serif text-base sm:text-lg font-semibold truncate ${
                isLight ? 'text-[#25201b]' : 'text-white drop-shadow-sm'
              }`}>
                {displayTitle}
              </h3>
              {displayCategory && (
            ...
            <span className={`text-[11px] tracking-[2px] uppercase mt-0.5 ${
              isLight ? 'text-[#746b62]' : 'text-white/50'
            }`}>
        ...
        <div className={`flex items-center gap-1 sm:gap-1.5 p-1.5 rounded-full backdrop-blur-xl transition-colors ${
          isLight
          ...
          <button
            ...
            title="Reducir (-) [Zoom]"
            className={`w-9 h-9 rounded-full flex items-center justify-center transition-all disabled:opacity-30 disabled:hover:bg-transparent cursor-pointer ${
              isLight
          ...
          <button
            ...
            className={`px-2.5 h-7 rounded-full text-[11px] font-semibold tracking-wider flex items-center justify-center hover:bg-[var(--accent)] hover:text-black transition-all cursor-pointer ${
              isLight
      ...
      >
        ...
        <button
          ...
          title="Anterior (←)"
          className={`fixed left-3 sm:left-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 rounded-full backdrop-blur-xl flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 cursor-pointer ${
            isLight
        ...
        <button
          ...
          title="Siguiente (→)"
          className={`fixed right-3 sm:right-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 rounded-full backdrop-blur-xl flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 cursor-pointer ${
            isLight
              ? 'bg-black/[0.06] hover:bg-black/15 text-[#25201b] border border-black/10 shadow-[0_10px_30px_rgba(0,0,0,0.08)]'
              : 'bg-white/[0.08] hover:bg-white/20 text-white border border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.5)]'
          } ${showControls ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
        ...
        <div className="relative max-w-[94vw] max-h-[82vh] flex items-center justify-center">
          ...
          <img
            ...
            className={`max-w-[92vw] max-h-[78vh] object-contain rounded-xl select-none transition-transform ${
          ...
          {showInfo && currentImage.description && (
            <div
              ...
              className={`absolute bottom-6 right-6 max-w-sm z-30 p-5 rounded-2xl backdrop-blur-2xl shadow-2xl animate-[fadeUp_0.2s_ease-out] ${
                isLight
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className={`text-xs cursor-pointer p-1 ${
                    isLight ? 'text-[#746b62] hover:text-[#25201b]' : 'text-white/50 hover:text-white'
                  }`}
                >
              ...
              <p className={`text-xs leading-relaxed mb-3 ${
                isLight ? 'text-[#746b62]' : 'text-white/80'
              }`}>
                {currentImage.description}
              </p>
              {currentImage.categoryName && (
                <div className={`text-[11px] flex items-center gap-1.5 border-t pt-2.5 ${
                  isLight ? 'text-[#746b62] border-black/10' : 'text-white/50 border-white/10'
                }`}>
      ...
      {showThumbnails && images.length > 1 && (
        ...
        >
          <div className={`max-w-4xl mx-auto p-2 rounded-2xl backdrop-blur-2xl transition-colors ${
            isLight
