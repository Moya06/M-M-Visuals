              ...
              {showDownloadMenu && (
                ...
                >
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2.5 rounded-xl text-xs transition-colors flex items-center gap-2.5 cursor-pointer ${isLight ? 'hover:bg-black/5' : 'hover:bg-white/10'
                      }`}
                  >
